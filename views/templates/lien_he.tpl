		...
		{* <div class="col container-right">
		  ...
		  <div class="overlay-right">
		    <div class="text-right">
				<a class="text-left" href="https://www.facebook.com/profile.php?id=100008383187780" ">Kim Quang Huy<br><br><br></a>
				<p>
					<br>Sinh Ngày: 17-02-1999<br><br>
				</p>
		    	<a class="text-left" href="mailto:vquang1571997@gmail.com?subject=feedback HQbook" "email me"><br>Email: kimquanghuyfb991@gmail.com</a>
		    </div>
		   </div>
		</div> *}
	</div>
